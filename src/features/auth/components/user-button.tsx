...
export const UserButton = () => {
    ...
    return (
        <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align='end' side='bottom' className='w-60 border shadow-md' sideOffset={10}>
                <div className='flex flex-col items-center justify-start gap-2 px-2.5 py-4'>
