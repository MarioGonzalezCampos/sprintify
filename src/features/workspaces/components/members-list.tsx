...
import { useDeleteMembers } from "@/features/members/api/use-update-member";
import { useUpdateMembers } from "@/features/members/api/use-delete-member";
...
export const MembersList = ( {  } : MembersListProps ) => {
    ...
    const { mutate: deleteMember, isPending: isDeletingMember } = useDeleteMembers();
    const { mutate: updateMember, isPending: isUpdatingMember } = useUpdateMembers();
